  ...
  return (
    <div className="flex flex-col flex-1 min-h-screen bg-surface-50">
      ...
      <main className="flex-1 p-6 space-y-5">
        ...
        {/* Reviews List */}
        {loading ? (
          <div className="flex items-center justify-center py-16 text-sm text-surface-400">Loading reviews…</div>
        ) : (
                ...
                <div key={review.id} className="bg-white rounded-xl border border-surface-200 p-5">
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-surface-900">{review.user_name || "Anonymous"}</p>
