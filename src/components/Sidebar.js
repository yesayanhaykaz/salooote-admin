  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-[228px] bg-white border-r border-surface-200 flex flex-col z-40">
      ...
      <div className="px-3 py-4 border-t border-surface-100">
        <div className="flex items-center gap-3 px-2 py-2.5 rounded-lg hover:bg-surface-50 transition-colors cursor-pointer">
          ...
          <LogOut size={14} className="text-surface-400 flex-shrink-0" />
        </div>
      </div>
    </aside>
  );
